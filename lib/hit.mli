...
(** [create t point normal direction material] is a hit of distance [t] along the ray, at [point],
    with a [normal], [direction] of the hitting ray, and a [material] at the location of the hit. *)
